...
#'
#' \code{dropTooCloseQTL}  Assists in simplifying models following stepwise model selection
#' @import qtl
#' @export
dropTooCloseQTL<-function(cross, qtl, formula, covar, pheno.col, method = "hk",
                       min.dist = 30){
