...
```{r}
lsms<-lsmeans4qtl(cross, phe = "X3.Methylsulfinylpropyl",form = "y ~ Q1 + Q2 + Q1*Q2", mod = mod, covar=NULL)

lsms<-lsms[!is.na(lsms$Q1) & !is.na(lsms$Q2),c("Q1","Q2","lsmean","SE","mean","sem")]
